        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <i class="fas fa-home mr-2"></i><span class=logo>baster</logo>
                </a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            @can('viewAny', App\Invitation::class)
                                <a href="{{ route('message.show') }}" class="btn btn-outline-secondary mr-2 mt-2 mt-md-0"><i class="far fa-envelope align-middle"></i></a>
                            @endcan
